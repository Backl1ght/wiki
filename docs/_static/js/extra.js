// code from OI-wiki(https://github.com/OI-wiki/OI-wiki/blob/master/docs/_static/js/extra.js)
...
function foo(response) {
  ...
  //   url += '/index';
  //   var script = document.createElement('script');
  //   document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/Backl1ght/Backlight-Wiki/commits/master/docs/${url}`);
...
// if (url == "/index.md") {
//   // HomePage
//   document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/Backl1ght/Backlight-Wiki/commits/master/docs/index.md`);
...
//   document.getElementsByTagName('head')[0].appendChild(script);
// } else {
//   document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/Backl1ght/Backlight-Wiki/commits/master`);
